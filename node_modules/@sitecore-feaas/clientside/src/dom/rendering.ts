...
import { Datascopes, queryScopes, serializeCH1RichText } from './data.js'
...
export function setDOMAttribute(element: HTMLElement, attribute: string, value: any, config?: FEAASCustomizations) {
  ...
  var placeholder = String(
    (element.getAttribute('data-path-placeholder') || target[prop as keyof HTMLElement]) ?? target.getAttribute(prop)
  )
