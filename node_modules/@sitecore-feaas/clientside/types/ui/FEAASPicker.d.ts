...
export declare function FEAASPickerProps(element: FEAASBase<any, any>): {
    ...
    context: FEAASPickerImports.SDK.Style.Context;
...
export declare class FEAASPicker extends FEAASBase<FEAASPickerProps, typeof FEAASPickerImports> {
    ...
    render({ placeholder, context, mode, children, variant }: React.PropsWithChildren<FEAASPickerProps>, { Picker, React, useLibrary }: typeof FEAASPickerImports): JSX.Element;
}
declare global {
    namespace JSX {
