  ...
  return (
    <VStack w="100%" width="full">
      ...
      <VStack w="80%" justifyContent="flex-start" textAlign="left">
        <Heading fontSize="18px" width="100%" w="full" textAlign="left" mt="20px">
          Promotional Code
        </Heading>
        ...
        <Heading fontSize="18px" width="100%" w="full" textAlign="left" mt="30px">
          Pay with card on file
        </Heading>

        <HStack w="100%" width="full" textAlign="left" fontSize="16">
          <Box border="1px" borderColor="gray.400" borderRadius="lg" bgColor="gray.200" p="2px">
      ...
      <Modal isOpen={isCreditCardModalOpen} onClose={() => setIsCreditCardModalOpen(false)}>
        <ModalOverlay />
        <ModalContent width="full" w="100%" maxWidth="500px">
      ...
      <Modal isOpen={isNewCreditCardModalOpen} onClose={() => setIsNewCreditCardModalOpen(false)}>
        <ModalOverlay />
        <ModalContent width="full" w="100%" maxWidth="600px">
          ...
          <ModalBody fontSize="16px">
            ...
            <VStack>
              ...
              <HStack>
                <Button type="button" bgColor="brand.500" color="white">
                  Add Payment Method
                </Button>
                <Button
                  type="button"
